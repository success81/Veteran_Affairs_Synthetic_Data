...
######################Insert Action#########################
    def insert_action(sent):
        ...
        quick_insert += " " #Delete possibly testing addition of space
...
va_entry_a = "The relationship the Portland VA has with OHSU is to bring over college students to practice on the Veteran.  Ask for an actual Doctor.   You may not know until they stab through your bursa sack or remove the wrong tooth."
